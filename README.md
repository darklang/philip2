Philip2 ("*fee-leap* the second") is a compiler from Elm OCaml, using the ReasonML/Bucklescript ecosystem. You can use it to do a semi-automated port of a codebase from Elm 0.18 to Bucklescript.
